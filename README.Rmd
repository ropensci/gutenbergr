...
* A function `gutenberg_download()` that downloads one or more works from Project Gutenberg by ID: for instance, `gutenberg_download(84)` downloads the text of "Frankenstein".
...
* We retrieve the book text directly from a default or user-specified mirror using links in the same format. For example, "Frankenstein" (book 84) is retrieved from `https://aleph.pglaf.org/8/84/84-0.txt`.
