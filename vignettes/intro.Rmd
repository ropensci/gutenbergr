...
* The [Natural Language Processing CRAN View](https://cran.r-project.org/web/views/NaturalLanguageProcessing.html) suggests many R packages related to text mining, especially around the [tm package](https://cran.r-project.org/web/packages/tm/index.html)
* You could match the `wikipedia` column in `gutenberg_author` to Wikipedia content with the [WikipediR](https://cran.r-project.org/web/packages/WikipediR/index.html) package or to pageview statistics with the [wikipediatrend](https://cran.r-project.org/web/packages/wikipediatrend/index.html) package
